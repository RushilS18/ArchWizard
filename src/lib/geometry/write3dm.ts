...
function createProfileCurve(rhino: Awaited<ReturnType<typeof rhino3dm>>, solid: SolidSpec) {
...
function createSolidExtrusion(
  rhino: Awaited<ReturnType<typeof rhino3dm>>,
  solid: SolidSpec,
) {
